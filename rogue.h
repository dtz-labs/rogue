...
char	pack_char();
char	readchar();
char	rnd_thing() ZX_BANKED_3;

char	*charge_str(THING *obj);
char	*choose_str(char *ts, char *ns) ZX_BANKED_3;
char	*inv_name(THING *obj, bool drop) ZX_BANKED_1;
char	*nullstr(THING *ignored);
char	*num(int n1, int n2, char type) ZX_BANKED_4;
char	*ring_num(THING *obj);
char	*set_mname(THING *tp) ZX_BANKED_6;
char	*vowelstr(char *str) ZX_BANKED_3;
